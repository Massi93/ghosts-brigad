...
import '../onboarding/privacy_consent_screen.dart';
import '../home/root_shell.dart';
import 'login_screen.dart';

/// Decides which top-level flow to show based on auth + consent + onboarding.
///
///   not signed in        → LoginScreen
///   not consented        → PrivacyConsentScreen  (GDPR)
  ...
  Widget build(BuildContext context) {
    return Consumer<UserProvider>(
      builder: (context, user, _) {
        ...
        if (!user.privacyAccepted) return const PrivacyConsentScreen();
